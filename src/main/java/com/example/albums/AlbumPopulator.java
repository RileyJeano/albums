...
//////////////////
		...
		artist2 = artistRepo.save(artist2);
			...
			Album album2 = new Album("Hanging Out and Doing Crafts", "google.com", artist2);
			...
			Album album3 = new Album("I'm Much Better Now", "google.com", artist2);
			album3 = albumRepo.save(album3);
			
				Song song5 = new Song("I Built A Bird House (Just For Myself)", "www.wwwwwww.com.co", "Just Long Enough", album3);
				song5 = songRepo.save(song5);
				
				Song song6 = new Song("Taking Up Birdwatching", "www.wwwwwwwwwwwwwwwww.com.co", "2:31", album3);
...
///////////////////////
		...
		artist3 = artistRepo.save(artist3);
			...
			Album album4 = new Album("How to Fight a Heyena", "google.com", artist3);
			...
			Album album5 = new Album("How to Fight a Heyena Part 2", "google.com", artist3);
